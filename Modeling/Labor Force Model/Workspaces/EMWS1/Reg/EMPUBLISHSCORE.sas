...
***  Effect: Age_group ;
_TEMP = 1;
_LP0 = _LP0 + (   -3145298.52426469) * _TEMP * _0_0;
_LP0 = _LP0 + (     6109326.1836647) * _TEMP * _0_1;
_LP0 = _LP0 + (    2777037.77203159) * _TEMP * _0_2;
*--- Intercept ---*;
_LP0 = _LP0 + (    6841935.56130173);
