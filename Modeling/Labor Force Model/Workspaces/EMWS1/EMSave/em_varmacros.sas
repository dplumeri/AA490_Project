...
%let EM_NUM_VARS = 12;
   %macro EM_VARS;
    Age_group EM_PREDICTION EM_SEGMENT EM_VALUETARGET Industry LABEL Population
   R_Sum_Labor_Force_Pop Sum_Labor_Force_Pop _WARN_ _dataobs_ b_Sum_Labor_Force_
   %mend EM_VARS;
%let EM_NUM_CLASS = 6;
   %macro EM_CLASS;
    Age_group EM_SEGMENT Industry LABEL _WARN_ b_Sum_Labor_Force_
   %mend EM_CLASS;
%let EM_NUM_INTERVAL = 6;
   %macro EM_INTERVAL;
    EM_PREDICTION EM_VALUETARGET Population R_Sum_Labor_Force_Pop
   Sum_Labor_Force_Pop _dataobs_
   %mend EM_INTERVAL;
