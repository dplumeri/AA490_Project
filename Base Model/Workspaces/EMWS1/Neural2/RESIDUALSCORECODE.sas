...
;
      ...
      label R_Population_in_thousands = 'Residual: Population_in_thousands' ;
...
*** ******************************;
IF MISSING( Population_in_thousands ) THEN R_Population_in_thousands  = . ;
ELSE R_Population_in_thousands  = Population_in_thousands  - 
        P_Population_in_thousands ;
