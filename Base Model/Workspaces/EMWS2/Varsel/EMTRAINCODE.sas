...
* EM: Create DMDB;
*------------------------------------------------------------*;
libname _spdslib SPDE "C:\Users\student\AppData\Local\Temp\SAS Temporary Files\_TD29064_830-5CG9310VLM_\Prc2";
...
*------------------------------------------------------------* ;
%macro INPUTS;
    AGE_GROUP DATE DISEASE GENDER OPT_POPULATION_IN_THOUSANDS
%mend INPUTS;
